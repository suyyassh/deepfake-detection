...
if __name__ == "__main__":
    B_WEIGHT = "results/training/weights/efficientnet_b0/baseline/baseline_20260603_030251.pth"
    N_WEIGHT = "results/training/weights/efficientnet_b0/novel/novel_20260603_030251.pth"
